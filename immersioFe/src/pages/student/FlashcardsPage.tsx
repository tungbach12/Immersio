            ...
            >
              ...
              <div
                className={cn(
                  ...
                  "bg-slate-900/40 border border-white/5 shadow-2xl"
                )}
                onClick={onFlip}
              >
                ...
                <div className="flex flex-col items-center justify-center h-full p-8 text-center relative">
                  ...
                  <div className="absolute top-8 left-0 right-0 flex flex-col items-center gap-2">
                    <p className="text-[9px] font-semibold text-slate-450 uppercase tracking-widest">
                      Mastery
                    </p>
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-white text-center leading-tight mt-4 italic tracking-tight">
                    {currentCard.front}
                  </h3>

                  <div className="absolute bottom-8 flex items-center gap-2 text-[10px] text-slate-455">
              ...
              <div
                className={cn(
                  "absolute inset-0 rounded-[2rem] cursor-pointer select-none overflow-hidden backface-hidden",
                  "bg-gradient-to-br from-indigo-950/80 to-slate-950 border border-white/5 shadow-2xl"
                )}
              ...
              >
                ...
                <div className="relative h-full flex flex-col items-center justify-center p-8 text-center">
                  <p className="text-[9px] font-semibold text-indigo-300 uppercase tracking-widest mb-4">
                    Definition
                  </p>

                  <h3 className="text-lg font-bold text-slate-350 italic mb-4">
                    {currentCard.front}
                  </h3>

                  <div className="w-10 h-0.5 bg-white/10 rounded-full mb-4" />

                  <p className="text-2xl md:text-3xl font-bold text-white leading-snug max-w-xs italic">
                    "{currentCard.back}"
                  </p>

                  {currentCard.explanation && (
                    <div className="mt-6 bg-slate-900/80 backdrop-blur-md p-4 rounded-2xl w-full border border-white/5">
                      <p className="text-sm text-indigo-205 leading-relaxed">
                        "{currentCard.explanation}"
                      </p>
                    </div>
                  )}
    ...
    >
      <div className="px-6 md:px-8 pt-6 pb-5">
        <div className="flex items-center gap-4 mb-5">
          <button
            onClick={onBack}
            className="w-11 h-11 rounded-2xl bg-white/5 border border-white/5 shadow-sm flex items-center justify-center text-slate-300 hover:bg-white/10 hover:border-indigo-500/30 transition-all"
          >
            <ChevronLeft className="w-5 h-5" />
          </button>
          <div>
      ...
      <div className="flex-1 overflow-y-auto px-6 md:px-8 pb-6">
        <div className="max-w-lg mx-auto">
          {/* Per-deck breakdown */}
          {decks.length > 0 && (
            <div className="glass-card bg-slate-900/40 border border-white/5 shadow-2xl p-6 rounded-3xl">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center">
                  <BarChart3 className="w-5 h-5 text-indigo-400" />
                </div>
                <p className="font-semibold text-white">Deck Breakdown</p>
              </div>
              <div className="space-y-3">
                {decks.map((deck, i) => (
                  <motion.button
                    ...
                    className="w-full text-left group"
                  >
                    <div className="rounded-xl p-4 bg-slate-900/20 hover:bg-slate-900/40 hover:border-indigo-500/30 border border-white/5 transition-all duration-300 active:scale-[0.98]">
                      <div className="flex items-center justify-between mb-1.5">
                        <h4 className="font-semibold text-sm text-slate-100 group-hover:text-indigo-400 transition-colors">
                          {deck.name}
                        </h4>
                        <ChevronLeft className="w-4 h-4 text-slate-400 group-hover:text-indigo-400 -rotate-180 transition-colors" />
                      </div>
