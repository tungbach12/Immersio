...
namespace Immersio.Application.Services
{
    public class AdminService : IAdminService
    {
        ...
        public async Task<SystemSettingsDto> GetAiSettingsAsync(CancellationToken cancellationToken)
        {
            ...
            var reasoningEffortGrammar = await GetSettingValueAsync("ReasoningEffortGrammar", "low", cancellationToken);
            var reasoningEffortFeedback = await GetSettingValueAsync("ReasoningEffortFeedback", "medium", cancellationToken);
            var reasoningEffortFlashcard = await GetSettingValueAsync("ReasoningEffortFlashcard", "medium", cancellationToken);
            var reasoningEffortPhrase = await GetSettingValueAsync("ReasoningEffortPhrase", "low", cancellationToken);
        ...
        public async Task SaveAiSettingsAsync(SystemSettingsDto settings, CancellationToken cancellationToken)
        {
            ...
            await SaveSettingValueAsync("ReasoningEffortGrammar", settings.ReasoningEffortGrammar ?? "low", cancellationToken);
            await SaveSettingValueAsync("ReasoningEffortFeedback", settings.ReasoningEffortFeedback ?? "medium", cancellationToken);
            await SaveSettingValueAsync("ReasoningEffortFlashcard", settings.ReasoningEffortFlashcard ?? "medium", cancellationToken);
            await SaveSettingValueAsync("ReasoningEffortPhrase", settings.ReasoningEffortPhrase ?? "low", cancellationToken);
